                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    onClick={() => {
                      ...
                      // ✅ Test notification - SES + YAZILI
                      manager.showTestNotification();
                      
                      // ✅ Ek sistem bildirimi
                      setTimeout(() => {
                        if ('Notification' in window && Notification.permission === 'granted') {
                          const testNotif = new Notification('✅ Test Başarılı!', {
                            body: 'Hem ses hem yazılı bildirim sistemi çalışıyor!',
                            icon: '/favicon.ico',
                            tag: 'test-success'
                          });
                      ...
                      toast.success('Test bildirimi gönderildi! (Ses + Yazılı)');
                    }}
