...
export async function POST(request: Request) {
  try {
    ...
    if (type === 'new_quote') {
      ...
      // Burada web push notification da gönderebilirsiniz
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <div style="padding: 20px; background: #f9f9f9;">
            ...
            <div style="margin-top: 20px; padding: 15px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px;">
              <strong>💡 Önemli:</strong> Bu teklif talebine en kısa sürede cevap verilmesi gerekmektedir.
            </div>
          </div>
          
          <div style="padding: 15px; text-align: center; background: #f1f1f1; border-radius: 0 0 10px 10px; color: #666; font-size: 14px;">
            Bu email otomatik olarak gönderilmiştir. | Enbal Sigorta
          </div>
        </div>
      `
    };
